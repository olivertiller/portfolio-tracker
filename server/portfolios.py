PORTFOLIOS = {
    ...
    "pmax": {
        ...
        "stocks": {
            # Europe-listed
            "ASML.AS":    {"name": "ASML Holding", "market": "Europe"},
            "RSGNz.XC":   {"name": "R&S Group Holding", "market": "Europe"},
            # Oslo Børs
            "AKER.OL":    {"name": "Aker", "market": "Nordic"},
            ...
            # Stockholm
            "SYNSAM.ST":  {"name": "Synsam", "market": "Nordic"},
            # Copenhagen
            "ROCK-A.CO":  {"name": "Rockwool A", "market": "Nordic"},
        },
    },
}
